window.addEventListener('load', function() {
    ...
    // Génère une liste de Pays via une API alternative
...
document.getElementById('registrationForm').addEventListener('submit', function(event) {
    ...
    if (document.getElementById('nom').value.trim().length < 2 || !/^[A-Za-zàâäéèêëïîôöùûüç]+([-'][A-Za-zàâäéèêëïîôöùûüç]+)*$/.test(document.getElementById('nom').value.trim())) {
        ...
        isValid = false;
        firstInvalidElement = firstInvalidElement || document.getElementById('nom'); // Stocke le premier élément invalide
    }
    ...
    if (document.getElementById('prenom').value.trim().length < 2 || !/^[A-Za-zàâäéèêëïîôöùûüç]+([-'][A-Za-zàâäéèêëïîôöùûüç]+)*$/.test(document.getElementById('prenom').value.trim())) {
        ...
        isValid = false;
        firstInvalidElement = firstInvalidElement || document.getElementById('prenom');
    }
    ...
    if (document.getElementById('adresse').value.trim().length < 2 || !/^[A-Za-zàâäéèêëïîôöùûüç0-9]+([ '-][A-Za-zàâäéèêëïîôöùûüç0-9]+)*$/.test(document.getElementById('adresse').value.trim())) {
        ...
        isValid = false;
        firstInvalidElement = firstInvalidElement || document.getElementById('adresse');
    }
    ...
    if (document.getElementById('ville').value.trim().length < 2 || !/^[A-Za-zàâäéèêëïîôöùûüç]+([-'][A-Za-zàâäéèêëïîôöùûüç]+)*$/.test(document.getElementById('ville').value.trim())) {
        ...
        isValid = false;
        firstInvalidElement = firstInvalidElement || document.getElementById('ville');
    }
    ...
    if (document.getElementById('codePostal').value.trim().length < 2 || !/^[0-9]+$/.test(document.getElementById('codePostal').value.trim())) {
        ...
        isValid = false;
        firstInvalidElement = firstInvalidElement || document.getElementById('codePostal');
    }
    ...
    if (!emailRegex.test(email)) {
        ...
        isValid = false;
        firstInvalidElement = firstInvalidElement || document.getElementById('email');
    }
    ...
    if (password !== confirm_password) {
        ...
        isValid = false;
        firstInvalidElement = firstInvalidElement || document.getElementById('confirm_password');
    }
    ...
    if (!isValid) {
        ...
        document.getElementById('error-form').style.display = 'none'; // Cache le message d'erreur général
