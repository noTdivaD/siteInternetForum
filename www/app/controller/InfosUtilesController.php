<?php
class InfosUtilesController {
    private $model;

    public function __construct() {
        require_once BASE_PATH . '/app/model/InfosUtilesModel.php';
        require_once BASE_PATH . '/config/config.php'; // Inclure la configuration
        $this->model = new InfosUtilesModel();
        error_log("Controller AccueilController loaded successfully.");
    }

    public function index() {
        require_once BASE_PATH . '/app/view/infos_utiles.php';
